...
from .models import Banner,Category,Brand,Product,ProductAttribute, Subcategory,letsPay
...
def subcategory_list(request):
    ...
    return render(request,'subcategory_list.html',{'data':data})
...
def letsPay1(request):
    ...
    if request.method=="POST":
        ...
        en=letsPay(cardname=cardname,price=price,cardnum=cardnum,expiry=expiry,cvc=cvc)
        en.save()
        n="Payment Done"
    return render(request, 'payment.html',{'n':n})
